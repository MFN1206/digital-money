...
function App() {
  return (
    <div className="bg-blue-500 w-full h-screen flex">
      ...
      <div
        className="bg-white w-1/2 h-full text-center flex justify-center items-center flex-col"
        name="direita"
      >
        ...
        <form className="w-full flex flex-col items-center justify-center">
          <div className="flex flex-col text-left w-3/5">
            ...
            <label htmlFor="email" className="border border-gray-300 px-4 py-1 rounded-md flex items-center gap-2 focus-within:border-blue-500">
