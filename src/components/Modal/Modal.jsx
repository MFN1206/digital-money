...
export default function Modal({ open, setOpen }) {
  ...
  //O tipo da transação, que pide ser "input" (entrada) ou "output" (saida)
      ...
      <Dialog open={open} onClose={setOpen} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className={"px-4 pt-5 pb-4 sm:p-6 sm:pb-4" + (darkMode ? " dark:bg-slate-800" : "bg-slate-800")}>
                    ...
                    <div className="mt-2 w-full space-y-5">
                      ...
                      <div className="flex justify-between">
                        ...
                        <button
                          ...
                          onClick={() => hnpmandleChangeType("output")}
                        >
                          <ArrowCircleDown
                            size={20}
